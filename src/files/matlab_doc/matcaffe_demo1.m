function matcaffe_demo1()

% init caffe network (spews logging info)
matcaffe_init(1);
%w=caffe('get_weights');
%save('/nfs/vision/victor_hao/w_7_ledata.mat','w');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fid1=fopen('../im_result_7_ledata_new.txt','w+');
...
if nargin < 2 || isempty(model_def_file)
  ...
  model_def_file = '../result_7_ledata/brca_7_deploy.prototxt';

end
if nargin < 3 || isempty(model_file)
  % By default use caffe reference model
  model_file = '../result_7_ledata/brca_iter_480000.caffemodel';
end
